...
public class MusicManagerGameBase : SerializedMonoBehaviour
{
    ...
    [SerializeField] private AudioClip clickSuccessSound;
    [SerializeField] private AudioClip clickFailSound;
    ...
    {
        PlaySingle(clickFailSound, SourceAudio.UI);
    }
    public void PlayClickSuccessSound()
    {
        PlaySingle(clickSuccessSound, SourceAudio.UI);
    }
    #endregion
